...
export default function(app, createdAt) {
  ...
  describe('Card disaster types', () => {
    let cardId;

    // Request a card, successfully submit 'assessment' report
    it('Put card data - assessment', function(done) {
      // First get card id
      test.httpAgent(app)
      .post('/cards')
      .send({
    ...
    it('Catches assessment card data schema error - No damages',
    function(done) {
      // First get card id
      test.httpAgent(app)
      .post('/cards')
      ...
      .end(function(error, response) {
        ...
        .end(function(err, res) {
          if (err) {
            test.fail(err.message + ' ' + JSON.stringify(res.body));
          } else {
            done();
          }
        });
    ...
    it('Catches assessment card data schema error - Invalid component',
    function(done) {
      // First get card id
      test.httpAgent(app)
      .post('/cards')
    ...
    it('Catches assessment card data schema error - Severity range',
    function(done) {
      // First get card id
      test.httpAgent(app)
      .post('/cards')
    ...
    it('Catches flood card data schema error - No flood_depth', function(done) {
      // First get card id
      test.httpAgent(app)
      .post('/cards')
      .send({
    ...
    it('Catches flood card data schema error - Depth range', function(done) {
      // First get card id
      test.httpAgent(app)
      .post('/cards')
      .send({
